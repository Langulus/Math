...
TEMPLATE_TEST_CASE("Round - Real", "[arithmetics]", REAL_TYPES) {
	using T = TestType;
	REQUIRE(Approx(Round(T(5.488)), T(5)));
	REQUIRE(Approx(Round(T(5.666)), T(6)));
	REQUIRE(Approx(Round(T(-5.488)), T(-5)));
	REQUIRE(Approx(Round(T(-5.666)), T(-6)));
	REQUIRE(Approx(Round(T(0)), T(0)));
	REQUIRE(Approx(Round(T(235266.52)), T(235267)));
	REQUIRE(Approx(Round(T(235266.49)), T(235266)));
	REQUIRE(Approx(Round(T(-235266.52)), T(-235267)));
	REQUIRE(Approx(Round(T(-235266.49)), T(-235266)));
}
...
TEMPLATE_TEST_CASE("Floor - Real", "[arithmetics]", REAL_TYPES) {
	using T = TestType;
	REQUIRE(Approx(Floor(T(5)), T(5)));
	REQUIRE(Approx(Floor(T(5.488)), T(5)));
	REQUIRE(Approx(Floor(T(5.666)), T(5)));
	REQUIRE(Approx(Floor(T(-5.488)), T(-6)));
	REQUIRE(Approx(Floor(T(-5.666)), T(-6)));
	REQUIRE(Approx(Floor(T(0)), T(0)));
	REQUIRE(Approx(Floor(T(235266.52)), T(235266)));
	REQUIRE(Approx(Floor(T(235266.49)), T(235266)));
	REQUIRE(Approx(Floor(T(-235266.52)), T(-235267)));
	REQUIRE(Approx(Floor(T(-235266.49)), T(-235267)));
}
...
TEMPLATE_TEST_CASE("Ceil - Real", "[arithmetics]", REAL_TYPES) {
	using T = TestType;
	REQUIRE(Approx(Ceil(T(5)), T(5)));
	REQUIRE(Approx(Ceil(T(5.488)), T(6)));
	REQUIRE(Approx(Ceil(T(5.666)), T(6)));
	REQUIRE(Approx(Ceil(T(-5.488)), T(-5)));
	REQUIRE(Approx(Ceil(T(-5.666)), T(-5)));
	REQUIRE(Approx(Ceil(T(0)), T(0)));
	REQUIRE(Approx(Ceil(T(235266.52)), T(235267)));
	REQUIRE(Approx(Ceil(T(235266.49)), T(235267)));
	REQUIRE(Approx(Ceil(T(-235266.52)), T(-235266)));
	REQUIRE(Approx(Ceil(T(-235266.49)), T(-235266)));
}

TEMPLATE_TEST_CASE("Square - Signed", "[arithmetics]", SIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx(Sq(T(-0)), T(0)));
	REQUIRE(Approx(Sq(T(-1)), T(1)));
	REQUIRE(Approx(Sq(T(-2)), T(4)));
	REQUIRE(Approx(Sq(T(-3)), T(9)));
	REQUIRE(Approx(Sq(T(-10)), T(100)));
}

TEMPLATE_TEST_CASE("Square - All", "[arithmetics]", ALL_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Sq(T(0)), T(0)));
	REQUIRE(Approx<T>(Sq(T(1)), T(1)));
	REQUIRE(Approx<T>(Sq(T(2)), T(4)));
	REQUIRE(Approx<T>(Sq(T(3)), T(9)));
	REQUIRE(Approx<T>(Sq(T(10)), T(100)));
}

TEMPLATE_TEST_CASE("Sqrt - Integers", "[arithmetics]", INTEGER_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Sqrt(T(0)), T(0)));
	REQUIRE(Approx<T>(Sqrt(T(1)), T(1)));
	REQUIRE(Approx<T>(Sqrt(T(4)), T(2)));
	REQUIRE(Approx<T>(Sqrt(T(9)), T(3)));
	REQUIRE(Approx<T>(Sqrt(T(100)), T(10)));
}

TEMPLATE_TEST_CASE("Sqrt - Real", "[arithmetics]", REAL_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Sqrt(T(2)), T(1.41421356237), T(0.000001)));
	REQUIRE(Approx<T>(Sqrt(T(245.23)), T(15.6598211995), T(0.000001)));
}

TEMPLATE_TEST_CASE("Lerp 1D - Real", "[arithmetics]", REAL_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Lerp(T(0), T(1), T(0.5)), T(0.5)));
	REQUIRE(Approx<T>(Lerp(T(0), T(1), T(0.75)), T(0.75)));
	REQUIRE(Approx<T>(Lerp(T(1), T(0), T(0.5)), T(0.5)));
	REQUIRE(Approx<T>(Lerp(T(1), T(0), T(0.75)), T(0.25)));
	REQUIRE(Approx<T>(Lerp(T(0), T(0), T(555.5)), T(0)));
	REQUIRE(Approx<T>(Lerp(T(666), T(666), T(555.5)), T(666)));
}

TEMPLATE_TEST_CASE("Frac 1D - Unsigned Integers", "[arithmetics]", UNSIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Frac(T(0)), T(0)));
	REQUIRE(Approx<T>(Frac(T(16)), T(0)));
}
...
TEMPLATE_TEST_CASE("Frac 1D - Real", "[arithmetics]", REAL_TYPES) {
	...
	REQUIRE(Approx<T>(Frac(T(-16)), T(0)));
	REQUIRE(Approx<T>(Frac(T(16)), T(0)));
	REQUIRE(Approx<T>(Frac(T(-66.2)), T(0.8), T(0.001)));
	REQUIRE(Approx<T>(Frac(T(66.55)), T(0.55), T(0.001)));
}

TEMPLATE_TEST_CASE("Mod 1D - Unsigned Integers", "[arithmetics]", UNSIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Mod(T(0), T(1)), T(0)));
	REQUIRE(Approx<T>(Mod(T(0), T(3)), T(0)));
	REQUIRE(Approx<T>(Mod(T(1), T(1)), T(0)));
	REQUIRE(Approx<T>(Mod(T(1), T(3)), T(1)));
	REQUIRE(Approx<T>(Mod(T(2), T(1)), T(0)));
	REQUIRE(Approx<T>(Mod(T(4), T(16)), T(4)));
}

TEMPLATE_TEST_CASE("Mod 1D - Signed Integers", "[arithmetics]", SIGNED_INTEGER_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Mod<T>(T(0), T(1)), T(0)));
	REQUIRE(Approx<T>(Mod<T>(T(0), T(3)), T(0)));
	REQUIRE(Approx<T>(Mod<T>(T(1), T(1)), T(0)));
	REQUIRE(Approx<T>(Mod<T>(T(1), T(3)), T(1)));
	REQUIRE(Approx<T>(Mod<T>(T(2), T(1)), T(0)));
	REQUIRE(Approx<T>(Mod<T>(T(4), T(16)), T(4)));
	REQUIRE(Approx<T>(Mod<T>(T(0), T(-1)), T(0)));
	REQUIRE(Approx<T>(Mod<T>(T(5), T(-2)), T(-1)));
	REQUIRE(Approx<T>(Mod<T>(T(-5), T(2)), T(1)));
	REQUIRE(Approx<T>(Mod<T>(T(-50), T(-23)), T(-4)));
}
...
TEMPLATE_TEST_CASE("Mod 1D - Real", "[arithmetics]", REAL_TYPES) {
	...
	REQUIRE(Approx<T>(Mod(T(4), T(16)), T(4)));
	REQUIRE(Approx<T>(Mod(T(0), T(-1)), T(0)));
	REQUIRE(Approx<T>(Mod(T(5), T(-2)), T(-1)));
	REQUIRE(Approx<T>(Mod(T(-5), T(2)), T(1)));
	REQUIRE(Approx<T>(Mod(T(-50), T(-23)), T(-4)));
	REQUIRE(Approx<T>(Mod(T(-2.1), -T(0.2)), T(-0.1)));
	REQUIRE(Approx<T>(Mod(T(5.555), T(2)), T(1.555)));
	REQUIRE(Approx<T>(Mod(T(5.555), T(-2)), T(-0.445)));
}

TEMPLATE_TEST_CASE("Min 1D - Signed", "[arithmetics]", SIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Min(T(0), T(5)), T(0)));
	REQUIRE(Approx<T>(Min(T(0), T(0)), T(0)));
	REQUIRE(Approx<T>(Min(T(-6), T(-10)), T(-10)));
}
...
TEMPLATE_TEST_CASE("Max 1D - Signed", "[arithmetics]", SIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Max(T(0), T(5)), T(5)));
	REQUIRE(Approx<T>(Max(T(0), T(0)), T(0)));
	REQUIRE(Approx<T>(Max(T(-6), T(-10)), T(-6)));
}
...
TEMPLATE_TEST_CASE("Clamp 1D - Signed", "[arithmetics]", SIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Clamp(T(0), T(5), T(10)), T(5)));
	REQUIRE(Approx<T>(Clamp(T(100), T(0), T(1)), T(1)));
	REQUIRE(Approx<T>(Clamp(T(0), T(-5), T(5)), T(0)));
	REQUIRE(Approx<T>(Clamp(T(0), T(0), T(0)), T(0)));
	REQUIRE(Approx<T>(Clamp(T(-6), T(-10), T(-9)), T(-9)));
	REQUIRE(Approx<T>(Clamp(T(12), T(10), T(15)), T(12)));
}
...
TEMPLATE_TEST_CASE("ClampRev 1D - Signed", "[arithmetics]", SIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(ClampRev(T(0), T(5), T(10)), T(0)));
	REQUIRE(Approx<T>(ClampRev(T(100), T(0), T(1)), T(100)));
	REQUIRE(Approx<T>(ClampRev(T(0), T(-5), T(5)), T(-5)));
	REQUIRE(Approx<T>(ClampRev(T(0), T(0), T(0)), T(0)));
	REQUIRE(Approx<T>(ClampRev(T(-6), T(-10), T(-9)), T(-6)));
	REQUIRE(Approx<T>(ClampRev(T(12), T(10), T(15)), T(10)));
}
...
TEMPLATE_TEST_CASE("Step 1D - Unsigned", "[arithmetics]", UNSIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Step(T(0), T(0)), T(1)));
	REQUIRE(Approx<T>(Step(T(1), T(1)), T(1)));
}
TEMPLATE_TEST_CASE("Step 1D - Signed", "[arithmetics]", SIGNED_INTEGER_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Step(T(0), T(0)), T(1)));
	REQUIRE(Approx<T>(Step(T(1), T(1)), T(1)));
	REQUIRE(Approx<T>(Step(T(-5), T(-16)), T(0)));
	REQUIRE(Approx<T>(Step(T(-5), T(-4)), T(1)));
}
TEMPLATE_TEST_CASE("Step 1D - Real", "[arithmetics]", REAL_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Step(T(1), T(0.5)), T(0)));
	REQUIRE(Approx<T>(Step(T(0), T(0)), T(1)));
	REQUIRE(Approx<T>(Step(T(1), T(1)), T(1)));
	REQUIRE(Approx<T>(Step(T(1), T(1.5)), T(1)));
	REQUIRE(Approx<T>(Step(T(-5), T(-16)), T(0)));
	REQUIRE(Approx<T>(Step(T(-5), T(-4)), T(1)));
}
...
TEMPLATE_TEST_CASE("Distance 1D - Integers", "[arithmetics]", UNSIGNED_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Distance(T(0), T(0)), T(0)));
	REQUIRE(Approx<T>(Distance(T(1), T(1)), T(0)));
}

TEMPLATE_TEST_CASE("Distance 1D - Integers", "[arithmetics]", SIGNED_INTEGER_TYPES) {
	using T = TestType;
	const T zero{ 0 };
	REQUIRE(Approx<T>(Distance<T>(zero, zero), zero));
	REQUIRE(Approx<T>(Distance<T>(T(1), T(1)), zero));
	REQUIRE(Approx<T>(Distance<T>(T(-5), T(-16)), T(11)));
	REQUIRE(Approx<T>(Distance<T>(T(-5), T(-4)), T(1)));
	REQUIRE(Approx<T>(Distance<T>(T(-5), T(7)), T(12)));
	REQUIRE(Approx<T>(Distance<T>(T(5), T(-7)), T(12)));
}

TEMPLATE_TEST_CASE("Distance 1D - Reals", "[arithmetics]", REAL_TYPES) {
	using T = TestType;
	REQUIRE(Approx<T>(Distance(T(1), T(0.5)), T(0.5)));
	REQUIRE(Approx<T>(Distance(T(0), T(0)), T(0)));
	REQUIRE(Approx<T>(Distance(T(1), T(1)), T(0)));
	REQUIRE(Approx<T>(Distance(T(1), T(1.5)), T(0.5)));
	REQUIRE(Approx<T>(Distance(T(-5), T(-16)), T(11)));
	REQUIRE(Approx<T>(Distance(T(-5), T(-4)), T(1)));
	REQUIRE(Approx<T>(Distance(T(-5), T(7)), T(12)));
	REQUIRE(Approx<T>(Distance(T(-7), T(5)), T(12)));
}
